...
function openEditModal(a) {
  ...
  if (document.getElementById('securityNewPassword')) {
    document.getElementById('securityNewPassword').value = '';
  }
  if (document.getElementById('securityConfirmPassword')) {
...
// ── UPDATE (profile + optional password) ─────────────────────────
async function handleUpdateAccount(a) {
  ...
  // Validate password only if the user typed something
  ...
  try {
    ...
    // 4. Clear password fields after successful save
    if (document.getElementById('securityNewPassword')) {
      document.getElementById('securityNewPassword').value = '';
    }
    if (document.getElementById('securityConfirmPassword')) {
...
// ── SECURITY TAB: PASSWORD REQUIREMENTS VALIDATION ───────────────
...
// ── SECURITY TAB: MESSAGES ───────────────────────────────────────
function showSecurityMsg(text, type = '') {
...
function hideSecurityMsg() {
  const el = document.getElementById('securityMsg');
  if (el) el.className = 'modal-message hidden';
}

// ── SECURITY TAB: PASSWORD RESET EMAIL ───────────────────────────
