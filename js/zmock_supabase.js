...
const mockReservations = [
  { reservation_id: 1, contact_name: 'Maria Dela Cruz', status: 'confirmed', event_type: 'Wedding Reception', event_date: dk(0), event_time: '02:00 PM', event_end_time: '06:00 PM', duration_hours: null, guest_count: 80, location_type: 'onsite', venue_location: null, package: { package_name: 'VIP Max', duration_hours: 4 } },
  { reservation_id: 2, contact_name: 'Juan Santos', status: 'pending', event_type: 'Birthday Party', event_date: dk(0), event_time: '10:00 AM', event_end_time: null, duration_hours: null, guest_count: 25, location_type: 'offsite', venue_location: 'Tagaytay Garden Hall', package: { package_name: 'VIP Lite', duration_hours: 2 } },
  ...
  { reservation_id: 5, contact_name: 'Grace Villanueva', status: 'approved', event_type: 'Christening', event_date: dk(3), event_time: '01:00 PM', event_end_time: null, duration_hours: null, guest_count: 35, location_type: 'onsite', venue_location: null, package: { package_name: 'VIP Lite', duration_hours: 2 } },
