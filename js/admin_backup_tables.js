...
export const BACKUP_TABLE_CONFIG = [
  ...
  { name: 'catering_section_rule',         pk: ['package_id', 'tag'] },
  ...
  { name: 'business_social_link',          pk: 'id' },
  ...
  { name: 'payment',                       pk: 'payment_id',
    defer: ['extension_id', 'reversal_of_payment_id', 'additional_head_request_id'] },
  { name: 'reservation_extensions',        pk: 'extension_id' },
  { name: 'reservation_additional_head_requests', pk: 'additional_head_request_id' },
  { name: 'receipts',                      pk: 'receipt_id' },
  { name: 'reservation_charges',           pk: 'charge_id' },
